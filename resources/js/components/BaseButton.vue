<template>
    <button 
        class="relative flex items-center justify-center border rounded overflow-hidden font-medium focus:outline-none focus:shadow-outline focus:border-blue-400"
...
export default {
    ...
    computed: {
        ...
        loadingIcon() {
            if (this.primary) return 'text-blue-500'
            if (this.danger) return 'text-red-400'
